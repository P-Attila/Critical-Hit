...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-screen bg-zinc-900 text-gray-300'>
        {/* Container */}
        <div className='max-w-[1000px] mx-auto p-4 flex-flex-col justify-center w-full h-full'>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                <div className='shadow-md shadow-teal-400 hover:scale-110 duration-500'>
                ...
                <div className='shadow-md shadow-teal-400 hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto' src={Google} alt="FireBase icon" />
